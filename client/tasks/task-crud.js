...
var dataTable = {
    ...
    editaction: 'dblclick',
    resizeColumn: true,
    url:  webix.proxy('meteor', Tasks),  // <-- this is it!
...
var list = {
    view: 'list',
    template: '#taskId# (#taskName#) is rated #taskDescription#',
    ...
    url: webix.proxy('meteor', Tasks.find({title: /e/}))  // Cursor
};
...
var detailForm = {
    ...
    id: 'detail-form',
    elements: [
        { view: 'text', name: 'taskId', label: 'Movie title' },
        { view: 'text', name: 'taskName', label: 'Year'},
        { view: 'text', name: 'taskDescription', label: 'Rating'},
        {
        ...
        rows: [
            {
                ...
                cols: [
                    ...
                    },
                    {
                        ...
                        rows: [
                            {
                                view: 'template', type: 'header', template: 'Tasks containing "e" (drag them!)'
                            },
                            list
                        ]
                    }
